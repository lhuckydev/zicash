                      ...
                      <div className="pt-2 flex gap-4">
                         ...
                         >
                           {slide.link_type === 'whatsapp' ? (
                             <><MessageCircle className="w-4 h-4 md:w-5 h-5" /> Chat With Us</>
                           ) : (
                             <><Zap className="w-4 h-4 md:w-5 h-5" /> Explore Now</>
                           )}
                         </Button>
                      </div>
                    )}
        ...
        {slides.map((_, i) => (
          <button 
            ...
            className={cn(
              ...
              current === i ? "bg-blue-600 w-12" : "bg-slate-200 w-3 hover:bg-slate-300"
            )}
          />
        ))}
      </div>
