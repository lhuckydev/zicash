          ...
          <div className="lg:col-span-7 space-y-10">
            ...
            <div className="flex items-end justify-between border-b border-slate-100 pb-8">
              ...
              <div className="flex items-center gap-2 mb-2">
                 <div className={cn("w-2.5 h-2.5 rounded-full animate-pulse", product.stock > 0 ? "bg-blue-500" : "bg-red-500")} />
                 <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">{product.stock > 0 ? `${product.stock} Units In Stock` : "Out of Stock"}</span>
              </div>
            </div>
