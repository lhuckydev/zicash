...
export function HeroSlider() {
  ...
  return (
    <section className="relative group pt-4 px-1 overflow-hidden flex justify-center w-full">
      <Carousel 
        setApi={setApi} 
      ...
      >
        <CarouselContent className="-ml-4 h-[180px] md:h-[450px] items-center">
          {slides.map((slide, index) => {
            ...
            const content = (
              <div className={cn(
                "relative h-[160px] md:h-[400px] rounded-[1.5rem] md:rounded-[3rem] overflow-hidden transition-all duration-1000 ease-out shadow-2xl group/item mx-auto",
